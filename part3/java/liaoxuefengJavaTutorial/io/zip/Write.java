  ...
  public static void main(String[] args) {
    ...
    try {
      try (
        ...
        File[] files = {
          new File(
            "D:\\IdeaProjects\\KongFuOfArchitect\\part3\\java\\liaoxuefengJavaTutorial\\io\\zip\\a.txt"
          ),
          new File(
            "D:\\IdeaProjects\\KongFuOfArchitect\\part3\\java\\liaoxuefengJavaTutorial\\io\\zip\\b.txt"
          ),
        };
        for (File f : files) {
